...
===================================
Standalone MITRE ATT&CK + NIST SP 800-61 Rev. 2 reference mapping for
ThreatMatrix.
...
(fine-grained RF + OSR). It exists so the Docker/FastAPI service and the
Flutter dashboard can enrich predictions with framework references WITHOUT
touching any trained model file.
...
PHASE_2_TIER_MAPPING: dict = {
    ...
    "Credential_Abuse": {
        ...
        "nist_response":         "Lock account, force password reset, alert team.",
        "mitre_mitigations": [
            "M1036 (Account Use Policies) — https://attack.mitre.org/mitigations/M1036/",
            "M1032 (Multi-factor Authentication) — https://attack.mitre.org/mitigations/M1032/",
            "M1027 (Password Policies) — https://attack.mitre.org/mitigations/M1027/",
...
PHASE_3_CLASS_MAPPING: dict = {
    ...
    "XSS": {
        ...
        "nist_severity":         "High",
        "nist_response": (
            "sanitise affected endpoint, force re-authentication, "
